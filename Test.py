...
res = tn.parse(target=u"2.5小时")  # target为待分析语句，timeBase为基准时间默认是当前时间
print(res)
print("====\n")
...
res = tn.parse(
    target=u"2013年二月二十八日下午四点三十分二十九秒", timeBase="2013-02-28 16:30:29"
)  # target为待分析语句，timeBase为基准时间默认是当前时间
print(res)
print("====\n")

res = tn.parse(
    target=u"我需要大概33天2分钟四秒", timeBase="2013-02-28 16:30:29"
)  # target为待分析语句，timeBase为基准时间默认是当前时间
print(res)
print("====\n")
